...
def combine_graphs():
    ...
    # Path to the CPU or GPU that we used for testing. EPOCHS_PATH_STRING will be used to get the full path later.
    hardware_name = "chris-1660ti"

    hardware_path = GPU_BASE_PATH + hardware_name
    ...
    COMBINED_PATH_CSVS = [ hardware_path + "/" + f"train{epoch}e" + "/" + "results.csv" for epoch in epochs ]
    ...
    base_image_name = f"{hardware_name}_combined_graphs"
